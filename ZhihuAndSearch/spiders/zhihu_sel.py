...
from ZhihuAndSearch.items import ZhihuQuestionItem, ZhihuAnswerItem, ZhihuZhuanlanItem
import re
...
class ZhihuSelSpider(scrapy.Spider):
    ...
    def parse_zhuanlan(self, response):
        ...
        zhuanlan_item_loader = ItemLoader(item=ZhihuZhuanlanItem(), response=response)
        ...
        zhuanlan_item_loader.add_css("comments_num", "buttion.BottomActions-CommentBtn::text")
    ...
    def parse_answer(self, response):
        ...
        answer_item_loader = ItemLoader(item=ZhihuAnswerItem(), response=response)
